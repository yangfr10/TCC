		...
		?>
          <tr>
			...
			<td><a href="Editar_evolução.php?id_evolução=<?php echo $dados['Id_evolucao']; ?> & id=<?php echo $id ?>" class="btn-floating blue darken-2"> <i class="material-icons">edit</i>
			    <a href="evolução_action/Evolução_delete.php?id_evolução=<?php echo $dados['Id_evolucao']; ?> & id=<?php echo $id; ?>" class="btn-floating red darken-1"> <i class="material-icons">delete</i>
			</td>
