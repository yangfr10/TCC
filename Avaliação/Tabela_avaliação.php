      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><a href="Editar_avaliação.php?id_avaliação=<?php echo $dados['Id_avaliacao']; ?> & id=<?php echo $id ?>" class="btn-floating blue darken-2"> <i class="material-icons">edit</i>
                <a href="avaliação_action/Avaliação_delete.php?id_avaliação=<?php echo $dados['Id_avaliacao']; ?> & id=<?php echo $id; ?>" class="btn-floating red darken-1"> <i class="material-icons">delete</i>
            </td>
